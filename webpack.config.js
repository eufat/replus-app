...
class WebcomponentsjsHtmlWebpackPlugin {
    apply(compiler) {
        compiler.hooks.compilation.tap('WebcomponentsjsHtmlWebpackPlugin', (compilation) => {
            compilation.hooks.htmlWebpackPluginAfterHtmlProcessing.tapAsync('WebcomponentsjsHtmlWebpackPlugin', (data, cb) => {
...
module.exports = {
    entry: {
        ...
        'src/components/main-app': './src/components/main-app.js',
    },
    devServer: {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([{from: 'images/', to: 'images/'}, {from: 'manifest/', to: 'manifest/'}, {from: '_redirects', to: '_redirects', toType: 'file'}, {from: 'manifest.json', to: 'manifest.json', toType: 'file'}]),
    ],
};
